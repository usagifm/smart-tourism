    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-danger">Tabel Operator</h6>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse($operators as $operator)
                                <tr>
                                    ...
                                    <td>
                                        @if ($operator->tokens()->count() > 0)
                                            <form action="{{ route('manage.operator.resetToken', $operator) }}"
