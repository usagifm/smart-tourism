...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">Vehicle Table</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('vehicles.update', $vehicle) }}" method="POST" class="col-4 mx-auto">
                ...
                <div class="form-group">
                    ...
                    <select name="vehicle_type_id" id="vehicle_type_id" class="form-control" required>
                        ...
                        <option value="{{$vehicleType->id}}" {{$vehicleType->id == $vehicle->vehicle_type_id ?
                ...
                <div class="form-group">
                    ...
                    <select name="rent_area_id" id="rent_area_id" class="form-control" required>
                        ...
                        <option value="{{$rentArea->id}}" {{ $vehicle->rent_area_id==$rentArea->id ? 'selected' :
